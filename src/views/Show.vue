...
export default {
    ...
    data () {
        return {
            ...
            error: false,
            article: [],
            commonHeaderContent: [{text: 'aa', icons: 'cc'}]
        }
    },
    methods: {
        getArticle () {
...
.detail
    ...
    & [hidden], .button span
        display: none;
    & b, strong, .highlight .k, .highlight .o, .highlight .gs, .highlight .kc, .highlight .kd, .highlight .kn, .highlight .kp, .highlight .kr, .highlight .ow
        font-weight: 700;
    & dfn, .highlight .ge
        font-style: italic;
    & .meta span, .meta .source
        vertical-align: middle;
    & .meta .avatar, .comment-meta .avatar
        ...
        border-radius: 2px;
        margin-right: 5px;
    & .meta .bio, .highlight .gh, .highlight .bp
        color: #999;
    & .night .comment-meta .author, .night .content, .night .meta .author, .highlight .go
        color: #888;
    & .night .headline-title, .night .headline-background .heading-content, .night .question-title
        color: #B8B8B8;
    ...
    & .highlight .m, .highlight .mf, .highlight .mh, .highlight .mi, .highlight .mo, .highlight .il
        color: #099;
    & .highlight .s, .highlight .sb, .highlight .sc, .highlight .sd, .highlight .s2, .highlight .se, .highlight .sh, .highlight .si, .highlight .sx, .highlight .s1, .highlight .ss
        color: #d32;
    & .highlight .na, .highlight .nb, .highlight .no, .highlight .nv, .highlight .vc, .highlight .vg, .highlight .vi
        color: teal;
    & .highlight .ne, .highlight .nf
        color: #900;
        font-weight: 700;
    & .answer h1, .answer h2, .answer h3, .answer h4, .answer h5
        font-size: 19px;
    & .meta .meta-item
        width: 39%;
        overflow: hidden;
    ...
    & .answer h1, .answer h2, .answer h3, .answer h4, .answer h5
        font-size: 19px;
    & .origin-source, a.origin-source:link
        display: block;
        margin: 25px 0;
        height: 50px;
        overflow: hidden;
    ...
    & .origin-source .source-logo, a.origin-source:link .source-logo
        float: left;
        width: 50px;
        height: 50px;
        margin-right: 10px;
    & .origin-source .text, a.origin-source:link .text
        line-height: 50px;
        height: 50px;
        font-size: 13px;
    ...
    & .origin-source-wrap.unfocused .focus-link 
        display: block;
    & .origin-source-wrap.unfocused .origin-source:before, .origin-source-wrap.unfocused .origin-source:after
        display: none;
    ...
    & .night .origin-source, .night .origin-source.with-link
        background: #292929;
        color: #666;
    & .night .origin-source .text, .night .origin-source.with-link .text
        color: #666;
    ...
    & .dudu-night hr
        color: #27282b;
        border-color: #27282b;
    & .dudu-night .meta .author, .dudu-night .meta .bio
        color: #555659;
    & .dudu-night .headline-title, .dudu-night .headline-background .heading-content, .dudu-night .question-title
        color: #919499;
    & .dudu-night .headline
        border-bottom: none;
    & .dudu-night img
        -webkit-mask-image: -webkit-gradient(linear, 0 0, 0 100%, from(rgba(0, 0, 0, 0.7)), to(rgba(0, 0, 0, 0.7)));
    & .dudu-night, .dudu-night .content-wrap
        background: #1d1e1f;
    ...
    & .dudu-night .icon-arrow-right
        ...
        width: 10px;
        height: 15px;
    & .dudu-night blockquote, .dudu-night sup
    ...
    & .dudu .headline
        border-bottom: none;
    & .dudu-night .origin-source, .dudu-night a.origin-source:link
        background: #222324;
